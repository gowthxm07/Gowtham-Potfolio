...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Engineered and deployed a production corporate website for Shree Labels, an industrial printing press based in Karur, Tamil Nadu. Built with zero-build native HTML5, CSS3, and ES6 JavaScript modules, featuring a 35+ custom property industrial design system, responsive product catalogue across five label substrates (cotton tape, taffeta, satin, custom, offset), four conscious sustainability pillars, verified international certifications (OEKO-TEX® Standard 100 & Sedex), real-time client reviews via Firebase Firestore onSnapshot with anonymous authentication, Google Maps factory geolocation, and direct quotation dispatch via EmailJS.",
    technologies: [
      "HTML5",
      "CSS3",
      "ES6 JavaScript",
    ...
    metrics: [
      "Zero-build runtime: Vanilla HTML5 / CSS3 / ES6 Modules",
      "Real-time sync: Firestore onSnapshot reviews",
      "Verified compliance: OEKO-TEX Standard 100 & Sedex",
      "Dispatch: EmailJS browser-to-inbox quotation conduit",
    ],
